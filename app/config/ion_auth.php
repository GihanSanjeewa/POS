 ...
 */
$config['site_title']                 = "DEMO";       // Site Title, example.com
$config['admin_email']                = "hradmin@earrow.net"; // Admin Email, admin@example.com
$config['hr_email']                   = "hr@earrow.net"; // Admin Email, admin@example.com
...
/*
 ...
 | Lead Registration URL send
 */
$config['student_reg_alert_mail'] = 'student_reg_alert_mail.tpl.php';



$config['new_agent_user_mail'] = 'new_agent_user_mail.tpl.php';
...
$config['new_agent_received_mail'] = 'new_agent_received_mail.tpl.php';
...
$config['new_agent_member_user_mail'] = 'new_agent_member_user_mail.tpl.php';
