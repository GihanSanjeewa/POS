                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" style="width: 430px;" name="st_phone_no" id="st_phone_no" data-parsley-group="block1" required data-parsley-required data-container="body"  data-parsley-trigger-after-failure="focusout changed.bs.select" data-parsley-type="digits" >
                                        <span class="error"></span>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" style="width: 430px;" name="st_home_no" id="st_home_no" data-parsley-group="block1" required data-parsley-required data-container="body"  data-parsley-trigger-after-failure="focusout changed.bs.select" data-parsley-type="digits" >
                                        <span class="error"></span>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-3">
                            ...
                            <div class="col-sm-6 col-lg-6">
                                ...
                                <div class="col-sm-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" style="width: 878px;" name="st_emp_office_phone" id="st_emp_office_phone" data-parsley-group="block3"  data-parsley-type="digits" data-parsley-minlength="10" data-parsley-maxlength="10">
                                        <span class="error"></span>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-6">
...
$('#program').change(function () {
        ...
        $.ajax({
            async: false,
            url: "<?php echo site_url('students/registration/get_programe_id'); ?>",
            type: "POST",
            data: {
    ...
    $('#university').change(function(){
        ...
        console.log(program);
        $.ajax({
            url: "<?php echo base_url('students/registration/get_university_data_by_uni_id'); ?>",
            type: "POST",
            dataType: "JSON",
            data:{
                university:$(this).val(),
    ...
    $(document).ready(function () {
        ...
        var url_citi = "<?php echo base_url('students/registration/get_citizenship'); ?>";
        ...
        sfw = $("#student_form").stepFormWizard({
            ...
            onFinish: function(i) {
                ...
                if (valid){
                    ...
                    url = "<?php echo base_url('students/registration/insert'); ?>";
