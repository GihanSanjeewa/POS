...
<div class="row" id="barcode_div">
    ...
    <div id="barcode_div_wrap">
            ...
            <table border="0" style="width:100%;border-collapse: collapse;">
                ...
                <tr>
                    <td style="width:80%; padding: 0px; height: 20px;">
                        <p style="font-size: 14px;text-align: right;"><?php echo $student_data->st_full_name; ?></p>
                        <p style="font-size: 14px;text-align: right;margin-bottom: -5px;"><strong>REG No</strong> : <?php echo $student_data->student_id; ?></p>
                        <p style="font-size: 14px;text-align: right;margin-bottom: -5px;"><strong>ID No</strong> : <?php echo $student_data->another_student_id; ?></p>
                        <p style="font-size: 14px;text-align: right;margin-bottom: -2px;"><strong>NIC No </strong>: <?php echo $student_data->st_nic_num; ?></p>
                    </td>
                    <td style="width:30%; padding: 0px; height: 20px;text-align: right;padding-left: 2px;">
                    <?php
        ...
        <div style="height: 54mm !important; width: 86mm !important;"><br>
            ...
            <p style="transform-origin: 0 0;text-align: -webkit-right;transform: rotate(-90deg);font-size: 12px;margin-left: 90%;margin-top: 10%;width: 27mm;"><strong>Date of Issue : <?php echo date('d/m/Y'); ?></strong></p>
