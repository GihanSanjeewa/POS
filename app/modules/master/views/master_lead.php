        ...
        <div class="element-wrapper">
            ...
            <div class="element-box">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item"><a class="nav-link active" role="tab" href="#pending" data-toggle="tab"> Lead Source</a></li>
                    
                </ul>
                <!-- Tab panes -->
                <div class="tab-content tabcontent-border">
                <div class="tab-pane p-20 active" role="tabpanel" id="pending">
                        <button type="button" onclick="add_lead()" class="btn btn-success pull-right"><i class="fa fa-plus"></i> New Lead Source</button>
                        <table class="table table-striped table-bordered table-hover table-header-fixed dt-responsive" id="LeadInfo" cellspacing="0" width="100%">
                            ...
                            <tr>
                                ...
                                <th class="all">Source Code</th>
                                <th class="all">Source Name</th>
                                    ...
                                    <form action="#" id="lead_form" class="form-horizontal">
                                        <div class="form-body">
                                            <div class="">
                                                ...
                                                <br>
                                                <div class="row">
                                                    <label class="control-label col-md-4" for="code" style='text-align: right;color:black;'><b>Source Code :</b></label>
                                                    <div class="col-md-6">
                                                        <input type="text" name="code" id="code" class="form-control" placeholder="Enter Source Code">
                                                        <span class="error-block"></span>
                                                    </div>
                                                </div>
                                                <br>
                                                <div class="row">
                                                    <label class="control-label col-md-4" for="source_title" style='text-align: right;color:black;'><b>Source Name :</b></label>
                                                    <div class="col-md-6">
                                                        <input type="text" name="source_title" id="source_title" class="form-control" placeholder="Enter Source Name">
                                                        <span class="error-block"></span>
                                                    </div>
                                                </div>
                                            </div>
...
$(document).ready(function(){
    ...
    LeadInfo = $('#LeadInfo').DataTable({
        ...
        "ajax": {
            ...
            "url": "<?php echo base_url()?>master/Master_lead_con/leades_list/",
            "type": "POST"
        },
        "columnDefs": [
            {
...
function edit_lead(id){
    ...
    $.ajax({
        ...
        url:"<?php echo base_url('master/master_lead_con/get_lead');?>",
        dataType:"JSON",
        type:"POST",
        data:{
            id:id,
        ...
        success:function(data){
            ...
            $('[name="source_title"]').val(data.lead.source_title);
...
function save(){
    ...
    var url;
    if(save_method == 'add'){
        url="<?php echo base_url('master/Master_lead_con/save'); ?>";
    }
    else{
        url="<?php echo base_url('master/Master_lead_con/update'); ?>";
    }
...
function view_lead(id){
    ...
    $.ajax({
        ...
        url: "<?php echo base_url('master/master_lead_con/view_lead'); ?>/"+id,
        type: "POST",
        dataType: "JSON",
        data:{
            '<?php echo $this->security->get_csrf_token_name(); ?>':'<?php echo $this->security->get_csrf_hash(); ?>'
        ...
        success:function(data){
            ...
            html +='</td>'+
                ...
                '<td>'+(data.lead.code ? data.lead.code:"No Source Code")+'</td>'+
                '</tr>' +
                '<tr>' +
                '<td valign="top"><label>Source Tittle</label></td>' +
                '<td>' +(data.lead.source_title ? data.lead.source_title:"No Source Tittle")+'</td>' +
                '</tr>' +
                '</tbody>';

            $('#view_lead').html(html);

            $('#view_modal .modal-title').text(" lead Info ");
