...
class Ion_auth
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('settings/administration_mod');
        $settings = $this->administration_mod->load_settings();
        $modules = $this->administration_mod->load_modules();
        ...
        if ($this->logged_in()) {
            ...
            $user = $this->user()->row();
            define("USER_NAME", $user->first_name);
            define("USER_ID", $user->id);             
            $x=$this->user_details($user->id);
            define("COMPANY_ID", $x->company_id); 
            define("COLOR_THEME", $this->administration_mod->setting('color_theme'));
            define("BT_COLOR", $this->administration_mod->setting('dt_bt_color'));
            define("MENU_H_COLOR", $this->administration_mod->setting('menu_h_color'));
            define("COMPANY_LOGO", $this->administration_mod->setting('company_logo'));
