    ...
    <div class="col-12">
        <div class="element-wrapper">
            ...
            <div class="row">
                <div class="col-sm-4 col-lg-3">
                    <div class="form-group">
                        ...
                        <input name="id" id="id" class="form-control selectpicker" data-live-search="true">
                        <b><br>(Note: Please Enter Valid Year) </b>
                        </input>
                ...
                <div class="col-sm-5 col-lg-3">
                    <div class="form-group">
                        ...
                        <select name="filter_intakes" id="filter_intakes" class="form-control selectpicker"
                                data-live-search="true">
                            <option value=""></option>
            ...
            <div class="card-header bg-info page-head-title-wrap">
                <h4 class="page-head-title card-title  text-white" style="display: inline-block">Annual-Enrollments-Report</h4>
            </div>
            <div class="element-box">
                ...
                <script>
                    ...
                    $('#filter_branches').change(function() {
                        ...
                        get_filter_data_course();
                        //get_pf_filter_course_discipline_data_set();
                    ...
                    function loadStudent() {
                        $('#view_data').empty();
                        var branch = document.getElementById("filter_branches").value;
                        var batch = document.getElementById("filter_batches").value;
                        var course = document.getElementById("filter_courses").value;
                        var intakes = document.getElementById("filter_intakes").value;
                        ...
                        $.ajax({
                            type: "post",
                            async: false,
                            url:"<?php echo base_url('reports/Annual_enrollment_con/check_enrollments');?>",
                            data: {
                    ...
                    function get_filter_data_set_cutoff() {
                        ...
                        // $('#filter_courses').html('');
                        $.ajax({
                            url: "<?php echo base_url('reports/Gender_report_con/get_process_branch_course_filter_data'); ?>",
                            type: "POST",
                            dataType: "JSON",
                            data: {
                                "<?php echo $this->security->get_csrf_token_name(); ?>": "<?php echo $this->security->get_csrf_hash(); ?>"
                    ...
                    function get_filter_data_course() {
                        ...
                        $('#filter_courses').html('');
                        $.ajax({
                            url: "<?php echo base_url('reports/Gender_report_con/get_process_course_filter_data'); ?>",
                            type: "POST",
                            dataType: "JSON",
                            data: {
                                "<?php echo $this->security->get_csrf_token_name(); ?>": "<?php echo $this->security->get_csrf_hash(); ?>"
                    ...
                    function get_pf_filter_batch_branch_data_set(course) {
                        ...
                        $.ajax({
                            url: "<?php echo base_url('reports/Gender_report_con/get_batch_by_branch'); ?>",
                            type: "POST",
                            dataType: "JSON",
                            data: {
                                branch: branch,
                    ...
                    $('#filter_courses').change(function() {
                        ...
                        get_pf_filter_course_discipline_data_set($(this).val());
                    });


                    function get_pf_filter_course_discipline_data_set(course) {

                        $('#filter_intakes').html('');
                        $.ajax({

                            url: "<?php echo base_url('reports/Gender_report_con/get_discipline_intake_by_course'); ?>",
                            type: "POST",
                            dataType: "JSON",
                            data: {
                                course: course,
                            ...
                            success: function(data) {
                                ...
                                $('#filter_intakes').html('<option value="">-- Select--</option>');
                                for (var i = 0; i < data.intakes_list.length; i++) {
                                    $('#filter_intakes').append('<option value="' + data.intakes_list[i].id +
                                        '">' + data
                                            .intakes_list[i].code + ' - ' + data.intakes_list[i].intake_name +
                                        ' - ' + data
                                            .intakes_list[i].year + '</option>');
                                }
