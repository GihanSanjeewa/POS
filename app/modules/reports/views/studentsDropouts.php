    ...
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Students-Dropout</li>
            </ol>
        </div>
    </div>
</div>
        ...
        <div class="element-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-sm-4 col-lg-3">
                    <div class="form-group">
                        <label><b>Dropout Types : </b></label>
                        <select name="dropout" id="dropout" class="form-control selectpicker" data-live-search="true">
            ...
            <div class="card-header bg-info page-head-title-wrap">
                <h4 class="page-head-title card-title  text-white" style="display: inline-block"> Students-Report-Dropouts</h4>
            </div>
            ...
            <script>
             function loadStudent() {
                 $('#view_data').empty();
                  var drop = document.getElementById("dropout").value;
                ...
                //  var student = document.getElementById("student").value;
                 ...
                 $.ajax({
                     type: "post",
                     async: false,
                     url:"<?php echo base_url('reports/Student_dropout_con/check_student_drop_Result');?>",
                     data: {
