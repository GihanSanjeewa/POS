    ...
    <div class="col-12">
        ...
        <div class="element-wrapper">
            ...
            <div class="card-header bg-info page-head-title-wrap">
                <h4 class="page-head-title card-title  text-white" style="display: inline-block"> User Management</h4>
                <button href="javascript:;" type="button" class="btn btn-success pull-right" onclick="add_user()"><i class="fa fa-plus-circle"></i> Add New User</button>
            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="tab-content tabcontent-border">
                                            ...
                                            <table class="df col-md-12 table" style="margin-top: 10px;width: 900px !important;">
                                                ...
                                                <!--<tr>
                                                    <th class="title_head">Branches <span style="color: red">*</span></th>
                                                    <th colspan="8">
                                                        <select name="user_branches[]" id="user_branches" class="selectpicker"  data-live-search="true" data-width="100%"   multiple>
                                                            <option value="">(--)</option>
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="title_head">Password</th>
                                                    <th>
                                            ...
                                            <table class="df col-md-12 table" style="margin-top: 10px;width: 900px !important;">
                                                ...
                                                <tr>
                                                    ...
                                                    <th>
                                                        ...
                                                        <span class="error-block"></span>
                                                    </th><th class="title_head">NIC No <span style="color: red">*</span></th>
                                                    <th>
                                                        <input type="text" name="nic_number" class="form-control" placeholder="NIC No">
                                                        <span class="error-block"></span>
                                                    </th>
                                                ...
                                                <!-- <tr>
                                                    <th class="title_head">Address</th>
                                                    <th>
                                                        <textarea name="address" class="form-control" placeholder="Address"></textarea>
                                                        <span class="error-block"></span>
                                                    </th>
                                                    <th class="title_head">Occupation(If any)</th>
                                                    <th>
                                                        <textarea name="occupation" class="form-control" placeholder="Occupation"></textarea>
                                                        <span class="error-block"></span>
                                                    </th>
                                                </tr> -->
                                                <!-- <tr>
                                                ...
                                                <!-- <tr>
                                                    <th class="title_head">Date of Birth <span style="color: red">*</span></th>
                                                    <th>
                                                        <input type="text" name="birthday" class="form-control date date-pick" data-date-format="yyyy-mm-dd" autocomplete="off" placeholder="Birthday">
                                                        <span class="error-block"></span>
                                                    </th>
                                                ...
                                                <tr>
                                                </th><th class="title_head">Employee ID <span style="color: red">*</span></th>
                                                    <th>
                                                        <input type="text" name="employee_id" class="form-control" placeholder="Employee ID">
                                                        <span class="error-block"></span>
                                                    </th>
                                                    <!-- <th class="title_head">Branch<span style="color: red">*</span></th>
                                                    <th>
                                                        <select name="branch" id="branch" class="form-control">
                                                            <option value=""></option>
                                                            <?php
                                                            foreach($branches as $branch){
                                                                echo '<option value="'.$branch->id.'">('.$branch->code.')'.$branch->name.'</option>';
                                                            }
                                                            ?>
                                                        </select>
                                                        <span class="error-block"></span>
                                                    </th> -->
                                                    </th><th class="title_head">Designation <span style="color: red">*</span></th>
                                                    <th>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        user_table = $('#user_datatable').DataTable({
            ...
            "ajax": {
                ...
                "url": "<?php echo base_url()?>settings/system_users/get_all_users",
                "type": "POST"
            },
    ...
    function edit_user(id)
    {
        ...
        $.ajax({
            url : "<?php echo site_url('settings/system_users/edit_user')?>/" + id,
            type: "GET",
            "data": {
                "<?php echo $this->security->get_csrf_token_name(); ?>": "<?php echo $this->security->get_csrf_hash(); ?>"
            },
            ...
            success: function(data)
            {
                ...
                $('#sys_user_id').val(data.std_info.id);
                ...
                $('#branch').val(data.std_info.branch_id);
                $('#active').val(data.std_info.status);
                ...
                $('[name="employee_id"]').val(data.std_info.employee_id);
                $('[name="designation"]').val(data.std_info.designation);
...
//                    window.location = "<?php //echo base_url('hr_payroll/user_list/index')?>//";
    ...
    function save()
    {
        ...
        var url='';
        if(save_method=='add'){
            url = "<?php echo base_url('settings/system_users/save'); ?>";
        }
        else{
            url = "<?php echo base_url('settings/system_users/update'); ?>";
        }
        $.ajax({
            url: url,
            type: "POST",
    ...
    function user_permissions(sys_u_p_id)
    {
        ...
        var url = "<?php echo site_url('settings/system_users/ajax_get_system_permissions_details_by_id'); ?>";
