<?php
class System_users_agent_mod extends CI_Model
{
    ...
    {
        $this->db->select('std.company_id,std.employee_id,std.designation,std.branch_id,std.status,std.id,std.user_id,std.title,std.full_name,std.name,std.address,std.phone,std.occupation,std.birthday,std.nic_number,std.gender,std.religion,auth_users.first_name,auth_users.username,auth_users.email,std.created_at,std.updated_at,std.status');
    ...
    // public function get_by_id_with_auth($id)
    // {
    //     $this->db->select('std.employee_id,std.designation,std.branch_id,std.status,std.id,std.user_id,std.title,std.full_name,std.name,std.address,std.phone,std.occupation,std.birthday,std.nic_number,std.gender,std.religion,auth_users.first_name,auth_users.username,auth_users.email,std.created_at,std.updated_at,std.status');
    //     $this->db->from('asms_users_info std');
    //     $this->db->join('auth_users','auth_users.id=std.id','left');
    //     $this->db->where('std.id',$id);
    //     $query = $this->db->get();
    ...
    public function getAllGroups()
    {
        ...
        $q = $this->db->query("SELECT * FROM auth_groups where id IN ('15','17','18')");
